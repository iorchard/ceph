...
#
# Author: Heechul Kim <jijisa@iorchard.net>
# from Author: Loic Dachary <loic@dachary.org>
#
...
# work is done
$SUDO env DEBIAN_FRONTEND=noninteractive mk-build-deps --install --remove $control || exit 1
